...
const ParticipationList = () => {
  ...
  const isEnseignant = AuthService.getRole() === "ENSEIGNANT";
  ...
  const fetchParticipations = async () => {
    ...
    try {
      ...
      // Search participation by student
      if (searchTerm !== "") {
  ...
  // Get students, teachers and competitions
  ...
  const onSubmit = async (data) => {
    ...
    try {
      await api.post(URL, participation);
  ...
  // Edit
  const openEditParticipation = (participation) => {
  ...
  // Delete
  const openDeleteParticipation = (id) => {
                  ...
                  <tr key={participation.id}>
                    ...
                    <td>
                      <span className="cell-strong">
                        {participation.eleve?.prenom}{" "}
                        {participation.eleve?.nom}
                      </span>
                    ...
                    <td>
                      <div className="flex justify-end gap-1">
                        ...
                        <button
                          onClick={() =>
                            openEditParticipation(participation)
                          }
